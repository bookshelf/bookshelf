module.exports = {
  ...
  'eager loads "belongsTo" -> "belongsTo" (comments -> post.blog)': function() {
    var result = {
      result: [{
        id: 1,
        post_id: 1,
    ...
    return {mysql: result, postgresql: result, sqlite3: result};
  }(),
  'eager loads "belongsTo" -> "belongsTo" (comment -> post.blog) by using load': function() {
    var result = {
      result: {
        id: 1,
        post_id: 1,
