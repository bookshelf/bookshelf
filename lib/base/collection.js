 ...
 *   attributes of existing models in the collection. If both this and the
 *   `remove` options are set to `true`, then the existing model will be
 *   removed and its attributes will be merged with the duplicate model.
 * @param {Boolean=} options.remove=true
 *   If set to `true` any duplicate models that are found will be removed from
 *   the collection. If both this and the `merge` options are set to `true`,
 *   then the existing model will be removed and its attributes will be merged
 *   with the duplicate model.
