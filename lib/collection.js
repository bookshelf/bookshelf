...
const BookshelfCollection = (module.exports = CollectionBase.extend(
  /** @lends Collection.prototype */
  {
     ...
     *   Foreign key in this collection's model. By default, the `foreignKey` is assumed to
     ...
     *   Upon a sucessful query resulting in no records returns. Only fired if `require: true` is
     *   passed as an option.
     * @param {Object=} options
