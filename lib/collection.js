...
var BookshelfCollection = _collection2.default.extend({
  ...
  fetchOne: _promise2.default.method(function (options) {
    ...
    var model = new this.model(options.withRelatedCondition);
  ...
  load: _promise2.default.method(function (relations, options) {
    ...
    return new _eager2.default(this.models, this.toJSON(options), new this.model(options.withRelatedCondition)).fetch(options).return(this);
  }),
  ...
  _handleEager: function _handleEager(response, options) {
    options = options ? options : {};
    return new _eager2.default(this.models, response, new this.model(options.withRelatedCondition)).fetch(options);
  }
