Bookshelf Active Record Basics
====================

This guide is an introduction to Bookshelf's Active Record Implementation.

After reading this guide, you will know:

* What Object Relational Mapping and Active Record are and how they are used.
...
Active Record provides a layer of the system responsible for representing business
...
mapping between models and database tables should be created. A `tableName`
property is provided for each model.
...
subclass the `ActiveRecord` class and you're good to go:
...
```ruby
p = new Product
p.set 'name': "Some Book"
console.log p.get 'name' # "Some Book"
```
...
```ruby
class CreatePublications extends ActiveRecord
  up: ->
