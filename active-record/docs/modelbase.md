...
This guide should provide you with all you need to get started using model classes.
ModelBase allows for helpers to interact with non-ActiveRecord models. ModelBase also helps building custom ORMs.

Introduction
------------

ModelBase is a library containing various modules used in developing frameworks that need to interact with the
Rails Action Pack library. ModelBase provides a known set of interfaces for usage in classes. Some of modules are explained below.
